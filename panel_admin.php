...
if (isset($_POST['login'])) 
{
    ...
    if ($admin) 
    {
        ...
        if (password_verify($password, $admin['password'])) 
        {
            ...
            header("Location: panel_admin.php"); // Redirigir a la página principal del administrador
...
<body>
    ...
    <nav class="barraMenu">
        ...
        <a class="barraMenu-enlace" href="administrar_pedidos.php"> Pedidos </a>
        <a class="barraMenu-enlace" href="agregar_arreglo.php">Agregar arreglo</a>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="producto">
                    ...
                    <!-- Botones de Editar y Borrar de cada imagen -->
                    <div class="producto-botones mt-2">
                        <!-- Enlace "Editar" con clase personalizada para el botón -->
                        <a href="editar_arreglo.php?id=' . $row['id'] . '" class="btn-editar">Editar</a>
                        
                        <!-- Enlace "Borrar" con clase personalizada para el botón y confirmación -->
                        <a href="borrar_arreglo.php?id=' . $row['id'] . '" class="btn-borrar" onclick="return confirm(\'¿Estás seguro de que deseas borrar este arreglo?\');">Borrar</a>
                    </div>
